...
if(window.history.forwart(1)!=null)
	window.hinstory.forwaord(1);</script>
</head>
<body>
<br>
<table>
   ...
   while(rs.next())
   {
   	%>
          ...
          <td> <%out.println(sno); %></td>
            ...
            <td> <i class="fa fa-inr"><%=rs.getString(10) %> </td>
            </tr>
         <%}
...
<div class="right-div">
<h3>Pay online on this Phone@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mobileNumber" value="<%=rs2.getString(3) %>" placeholder="Enter Mobile no." required >
